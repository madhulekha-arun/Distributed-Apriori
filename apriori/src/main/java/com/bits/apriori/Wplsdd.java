package com.bits.apriori;

/*****************************************************************************/
/***Wplsdd.java 

bin/hadoop dfs -copyFromLocal /home/madhulekha/Downloads/t/marketdata.txt /user/hduser/input/
or
bin/hadoop dfs -copyFromLocal /home/madhulekha/Downloads/data/space.txt /user/hduser/input/                                                                                                                

sudo javac -classpath /usr/local/hadoop/hadoop-core-1.1.2.jar -d / /home/madhulekha/Downloads/Wplsdd.java

sudo jar cf plsdd.jar /sat4

bin/hadoop jar plsdd.jar sat4.Wplsdd /user/hduser/input/marketdata.txt /user/hduser/out/output1 /user/hduser/out/output2 /user/hduser/out/output3 /user/hduser/out/output4 /user/hduser/out/output5 /user/hduser/out/output6 /user/hduser/out/output7
or
bin/hadoop jar plsdd.jar sat4.Wplsdd /user/hduser/input/space.txt /user/hduser/out/output1 /user/hduser/out/output2 /user/hduser/out/output3 /user/hduser/out/output4 /user/hduser/out/output5 /user/hduser/out/output6 /user/hduser/out/output7
/*****************************************************************************/
...
public class Wplsdd 
{
	...
	public static class Map1 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		protected void setup(
			...
			File cacheFile = new File("sample1");
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			for(int x=0;x<hh.size();x++) {
				sub=hh.get(x);
				sub2=sub.split(" ");
				if(org.contains(sub2[0])&&org.contains(sub2[1]))
				{	
					word.set(sub);
					context.write(word, one);	
				}
	...
	public static class Map2 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		protected void setup(
			...
			File cacheFile = new File("sample2");
			BufferedReader reader = new BufferedReader(new FileReader(cacheFile));
			String content = null;
			hh = new ArrayList<String>();
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			//Path InFile = new Path("cop/sample/sample2.txt");
			//BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(InFile)));
			String sub,sub2[];
			for(int x=0;x<hh.size();x++) {
				sub=hh.get(x);
				sub2=sub.split(" ");
				if(org.contains(sub2[0])&&org.contains(sub2[1])&&org.contains(sub2[2]))
				{	
					word.set(sub);
					context.write(word, one);	
				}
	...
	public static class Map3 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		protected void setup(
			...
			File cacheFile = new File("sample3");
			BufferedReader reader = new BufferedReader(new FileReader(cacheFile));
			String content = null;
			hh = new ArrayList<String>();
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			for(int x=0;x<hh.size();x++) {
				sub=hh.get(x);
				sub2=sub.split(" ");
				if(org.contains(sub2[0])&&org.contains(sub2[1])&&org.contains(sub2[2])&&org.contains(sub2[3]))
				{	
					word.set(sub);
					context.write(word, one);	
				}
	...
	public static class Map4 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		protected void setup(
			...
			File cacheFile = new File("sample4");
			BufferedReader reader = new BufferedReader(new FileReader(cacheFile));
			String content = null;
			hh = new ArrayList<String>();
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			for(int x=0;x<hh.size();x++) {
				sub=hh.get(x);
				sub2=sub.split(" ");
				if(org.contains(sub2[0])&&org.contains(sub2[1])&&org.contains(sub2[2])&&org.contains(sub2[3])&&org.contains(sub2[4]))
				{	
					word.set(sub);
					context.write(word, one);	
				}
	...
	public static class Map5 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		protected void setup(
			...
			File cacheFile = new File("sample5");
			BufferedReader reader = new BufferedReader(new FileReader(cacheFile));
			String content = null;
			hh = new ArrayList<String>();
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			for(int x=0;x<hh.size();x++) {
				sub=hh.get(x);
				sub2=sub.split(" ");
				if(org.contains(sub2[0])&&org.contains(sub2[1])&&org.contains(sub2[2])&&org.contains(sub2[3])&&org.contains(sub2[4])&&org.contains(sub2[5]))
				{	
					word.set(sub);
					context.write(word, one);	
				}
	...
	public static class Map6 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		protected void setup(
			...
			File cacheFile = new File("sample6");
			BufferedReader reader = new BufferedReader(new FileReader(cacheFile));
			String content = null;
			hh = new ArrayList<String>();
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			for(int x=0;x<hh.size();x++) {
				sub=hh.get(x);
				sub2=sub.split(" ");
				if(org.contains(sub2[0])&&org.contains(sub2[1])&&org.contains(sub2[2])&&org.contains(sub2[3])&&org.contains(sub2[4])&&org.contains(sub2[5])&&org.contains(sub2[6]))
				{	
					word.set(sub);
					context.write(word, one);	
				}
	...
	public static void main(String[] args) throws Exception 
	{
		...
		i=0;
		job[i]=new Job(conf,"Wplsdd");
		job[i].setJarByClass(Wplsdd.class);
		...
		m=k;
		String s2="cop/sample/sample1.txt";
		...
		URI samp1 = URI.create("cop/sample/sample1.txt#sample1");
		...
		String s2="cop/sample/sample2.txt";
		Path outFile = new Path(s2);
		FileSystem fsw = FileSystem.get(conf);
		FSDataOutputStream out = fsw.create(outFile);
		BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		URI samp2 = URI.create("cop/sample/sample2.txt#sample2");
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			p=ii;
			String s2="cop/sample/sample3.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		URI samp3 = URI.create("cop/sample/sample3.txt#sample3");
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			q=ii;
			String s2="cop/sample/sample4.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		URI samp4 = URI.create("cop/sample/sample4.txt#sample4");
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			String s2="cop/sample/sample5.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		URI samp5 = URI.create("cop/sample/sample5.txt#sample5");
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			String s2="cop/sample/sample6.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		URI samp6 = URI.create("cop/sample/sample6.txt#sample6");
