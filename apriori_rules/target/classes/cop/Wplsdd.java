...
public class Wplsdd 
{
	...
	public static class Map1 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			Path InFile = new Path("hdfs://ubuntu:54310/user/hduser/sample/sample1.txt");
	...
	public static class Map2 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			FileSystem fs = FileSystem.get(context.getConfiguration());
			Path InFile = new Path("hdfs://ubuntu:54310/user/hduser/sample/sample2.txt");
			BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(InFile)));
			String sub;
			while ((sub = br.readLine()) != null) {
				StringTokenizer itlo=new StringTokenizer(sub);
	...
	public static class Map3 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			FileSystem fs = FileSystem.get(context.getConfiguration());
			Path InFile = new Path("hdfs://ubuntu:54310/user/hduser/sample/sample3.txt");
			BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(InFile)));
			String sub;
			while ((sub = br.readLine()) != null) {
				StringTokenizer itlo=new StringTokenizer(sub);
	...
	public static class Map4 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			FileSystem fs = FileSystem.get(context.getConfiguration());
			Path InFile = new Path("hdfs://ubuntu:54310/user/hduser/sample/sample4.txt");
			BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(InFile)));
			String sub;
			while ((sub = br.readLine()) != null) {
				StringTokenizer itlo=new StringTokenizer(sub);
	...
	public static class Map5 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			FileSystem fs = FileSystem.get(context.getConfiguration());
			Path InFile = new Path("hdfs://ubuntu:54310/user/hduser/sample/sample5.txt");
			BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(InFile)));
			String sub;
			while ((sub = br.readLine()) != null) {
				StringTokenizer itlo=new StringTokenizer(sub);
	...
	public static class Map6 extends Mapper<LongWritable, Text, Text, IntWritable> 
	{
		...
		public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException 
		{
			...
			FileSystem fs = FileSystem.get(context.getConfiguration());
			Path InFile = new Path("hdfs://ubuntu:54310/user/hduser/sample/sample6.txt");
			BufferedReader br = new BufferedReader(new InputStreamReader(fs.open(InFile)));
			String sub;
			while ((sub = br.readLine()) != null) {
				StringTokenizer itlo=new StringTokenizer(sub);
	...
	public static void main(String[] args) throws Exception 
	{
		...
		m=k;
		String s2="hdfs://ubuntu:54310/user/hduser/sample/sample1.txt";
		...
		String s2="hdfs://ubuntu:54310/user/hduser/sample/sample2.txt";
		Path outFile = new Path(s2);
		FileSystem fsw = FileSystem.get(conf);
		FSDataOutputStream out = fsw.create(outFile);
		BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			p=ii;
			String s2="hdfs://ubuntu:54310/user/hduser/sample/sample3.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			q=ii;
			String s2="hdfs://ubuntu:54310/user/hduser/sample/sample4.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			String s2="hdfs://ubuntu:54310/user/hduser/sample/sample5.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
		...
		try {	FileSystem fs=FileSystem.get(conf);
			...
			String s2="hdfs://ubuntu:54310/user/hduser/sample/sample6.txt";
			Path outFile = new Path(s2);
			FileSystem fsw = FileSystem.get(conf);
			FSDataOutputStream out = fsw.create(outFile);
			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(out));
